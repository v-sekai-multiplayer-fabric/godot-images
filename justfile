...
export GODOT_PINNED_REF := "v2026.06.26.2103-multiplayer-fabric"
...
# Collect debug symbols from editors/ and tpz/ into a single directory.
# Windows: .pdb  Linux/macOS: .debugsymbols
